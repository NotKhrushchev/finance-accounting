...
const Footer = () => {
    ...
    return (
        <>
            {isDesktop && (
                <footer className="bg-gray-800 py-4 flex items-center flex-col max-h-[142px]">
                    <p className="text-lg mb-5">Contacts:</p>
                    <ul className="flex gap-8">
                        ...
                        <li>
                            <a
                                href="https://vk.com/notkhrushchev"
                                target="_blank"
                            >
                                <Icon
                                    svg={VK}
                        ...
                        <li>
                            <a
                                href="mailto:nikitafilemine1@gmail.com"
                                target="_blank"
                            >
                                <Icon
                                    svg={Email}
